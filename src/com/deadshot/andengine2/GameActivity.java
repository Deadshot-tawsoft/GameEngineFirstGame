...
public class GameActivity extends BaseGameActivity {
	...
	public EngineOptions onCreateEngineOptions() {
		...
		Camera mCamera = new Camera(0, 0, CAMERA_WIDTH, CAMERA_HEIGHT); // set
																		// the
																		// camera
	...
	private void loadGfx() {
		...
		playerTextureRegion = new BitmapTextureAtlasTextureRegionFactory()
	...
	public void onPopulateScene(Scene pScene,
		...
		//continuesly rotating 
		sPlayer.registerEntityModifier(new LoopEntityModifier(new ParallelEntityModifier (new RotationModifier(6f,0f,360f), new MoveModifier(0,0,0,0,0))));
